...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
     ...
     let new_waiter = {id = new_id ; action = listener} in
     evt := new_waiter :: !evt;
     new_id ;;
...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let rec remove_inner (evt : 'a event) (i : id) (prev : 'a waiter list) : unit =
      match !evt with 
      | [] -> ()
      | h::t -> if h.id = i then
                  evt := t @ prev
                else
                  remove_inner (ref t) i (h :: prev) in
    remove_inner evt i [] ;;
...
......................................................................*)
  ...
  let fire_event (evt : 'a event) (arg : 'a) : unit =
    ignore(List.map (fun x -> x.action arg) !evt) ;;
...
let fakenews = WEvent.add_listener newswire fakeNewsNetwork ;;
let buzzfake = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire fakenews ;;
WEvent.remove_listener newswire buzzfake ;;
...
let receive_report (arg : 'a) : unit = 
  ignore(WEvent.add_listener publish arg) ;;
